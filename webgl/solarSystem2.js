/* 
* @Author: omni360
* @Date:   2014-08-19 20:45:14
* @Last Modified by:   omni360
* @Last Modified time: 2014-08-19 22:22:17
*/
//构造太阳系对象
...
SolarSystemApp.prototype.handleMouseMove = function(x,y){
	if(this.mouseDown){
		...
		{
			this.root.roation.x += (dy * 0.01);
			//剪切场景区域
			if(this.root.roation.x < 0)
...
/*		planet.init({animateOrbit:true,animateRotation:true,showOrbit:true,distance:spec.distance * SolarSystemApp.EARTH_DISTANCE + Sun.SIZE_IN_EARTHS,period:spec.period,revolutionSpeed:0.002,map:spec.map});
*/		
		planet.init({animateOrbit:true, animateRotation: true, showOrbit:true,distance:spec.distance * SolarSystemApp.EARTH_DISTANCE + Sun.SIZE_IN_EARTHS,size:spec.size * SolarSystemApp.EXAGGERATED_PLANET_SCALE,period : spec.period,revolutionSpeed : 0.002,map : spec.map});
